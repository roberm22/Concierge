...
export default class RoomServices extends React.Component {
    ...
    render() {
        ...
        let photos2 = [
            'https://lh3.googleusercontent.com/proxy/4jU1ujXA5lrTeTwUb2Nj-YAniDPL9dHaJciX-KYepmE36jSNgTLChQATBli0iZ0w8H9lHs6C1RLaFiOo5mKJZ-vHuyIM4SE1q-T3y3npYsc8MqaeE6M7rqi9vQmVFE09',
                    ...
                    <div className="main-content" id="mainInfoRoom">
                            ...
                            <div className="container">
                                <div className="row">
                                    <div className="displayFlex">
                                        ...
                                        <p>
                                            Common in 4 and 5-star hotels, it is assisted by a human team,
                                            machinery and specific material that takes care of it.
                                            It is widely used in holiday areas, and usually has a regional nod in
                                            its content, including typical dishes.
                                        </p>
                                        <p>
                                            <strong>AVAILABLE HOURS</strong><br/>
                                            06:00 – 12:00 Breakfast<br/>
                                            12:00 – 18:00 Lunch<br/>
                                            18:00 – 24:00 Dinner
                                        </p>
                            ...
                            <div className="container">
                                <div className="row">
                                    ...
                                    <div className="displayFlex">
                                        ...
                                        <p>
                                            It is a premium service, very current in 5-star vacation hotels.
                                            It consists in that the rooms have an area equipped for the preparation
                                            and service of dishes. The cook, with the assistance of a waiter, performs
                                            the entire process on-site, whether or not the client is present.
                                        </p>
                                        <p>
                                            <strong>AVAILABLE HOURS</strong><br/>
                                            07:00 – 10:30 Breakfast<br/>
                        ...
                        <article className="firstArticle">
                            <div className="container">
                                <div className="row">
                                    <div className="displayFlex">
                                        <h2 className="articleTitle">Room Service 12 hours assisted</h2>
                                        <p>
                                            This service covers the hours of activity of a hotel from breakfast to dinner and for this it has the support of:<br/><br/>

                                            - Kiosk system , normally at the reception, which has a minimum range of food and beverages for 24 hours.<br/>

                                            - Vending system , with self-service machines in the self-checkout and self-service plants.<br/>

                                            - Mini bar, inside the rooms. Area equipped with a mini bar with an assortment of snacks.<br/>

                                            - External deals, external offers of fast food restaurants at home that accompany and reinforce the Room Service menu.
                                        </p>
